...
st.header('Sources and Attribution')
st.markdown("""
            #### Data Sources: 
            - Match, Player, and Team Data : https://www.vlr.gg/
            - IGL and Winnings Data : https://liquipedia.net/
            - Mapping Data, Riot Games Public Bucket : https://vcthackathon-data.s3.us-west-2.amazonaws.com
